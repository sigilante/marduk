"""Tests for ``marduk.evaluator`` — cell-level driver.

Drives ``MardukEvaluator.eval_cell`` end-to-end against representative cell
...
from marduk.evaluator import CellResult, MardukEvaluator
from marduk.expander import Env
...
def test_backend_unknown_rejected():
    with pytest.raises(ValueError, match="unknown backend"):
        MardukEvaluator(backend="reaver")
